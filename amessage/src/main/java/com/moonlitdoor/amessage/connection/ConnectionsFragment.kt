...
import com.moonlitdoor.amessage.databinding.FragmentConnectionsBinding
import com.moonlitdoor.amessage.databinding.ListItemConnectionConnectedBinding
import com.moonlitdoor.amessage.databinding.NavigationHeaderBinding
...
class ConnectionsFragment : androidx.fragment.app.Fragment(), Observer<String?> {
  ...
  override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? =
    DataBindingUtil.inflate<FragmentConnectionsBinding>(inflater, R.layout.fragment_connections, container, false).also {
      ...
      it.fab.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.actionConnectionsFragmentToConnectFragment))
