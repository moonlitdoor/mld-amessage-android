object D {
  ...
  object Com {
    object Android {
      object Tools {
        object Build {
          const val gradle = "com.android.tools.build:gradle:4.0.0-alpha06"
        }
      }
    }
    ...
    object Google {
      ...
      object Firebase {
        ...
        const val firebaseConfig = "com.google.firebase:firebase-config:19.0.4"
  ...
  object Org {
    ...
    object Koin {
      private const val version = "2.1.0-alpha-7"
