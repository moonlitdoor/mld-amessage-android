object D {
  ...
  const val androidxLifecycleLifecycleExtensions = "androidx.lifecycle:lifecycle-extensions:2.2.0-alpha04"
  const val androidxLifecycleLifecycleLivedataKtx = "androidx.lifecycle:lifecycle-livedata-ktx:2.2.0-alpha04"
  const val androidxLifecycleLifecycleRuntimeKtx = "androidx.lifecycle:lifecycle-runtime-ktx:2.2.0-alpha04"
  const val androidxLifecycleLifecycleViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:2.2.0-alpha04"
  const val androidxNavigationNavigationFragmentKtx = "androidx.navigation:navigation-fragment-ktx:2.2.0-alpha02"
  const val androidxNavigationNavigationSafeArgsGradlePlugin = "androidx.navigation:navigation-safe-args-gradle-plugin:2.2.0-alpha02"
  const val androidxNavigationNavigationUiKtx = "androidx.navigation:navigation-ui-ktx:2.2.0-alpha02"
  ...
  const val comGoogleFirebaseFirebaseConfig = "com.google.firebase:firebase-config:19.0.1"
  ...
  const val orgJetbrainsKotlinxKotlinxCoroutinesAndroid = "org.jetbrains.kotlinx:kotlinx-coroutines-android:1.3.1"
  const val orgJetbrainsKotlinxKotlinxCoroutinesCore = "org.jetbrains.kotlinx:kotlinx-coroutines-core:1.3.1"
