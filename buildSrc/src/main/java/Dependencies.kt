object D {
  ...
  const val androidxCameraCameraCamera2 = "androidx.camera:camera-camera2:1.0.0-alpha04"
  const val androidxCameraCameraCore = "androidx.camera:camera-core:1.0.0-alpha04"
  const val androidxConstraintlayoutConstraintlayout = "androidx.constraintlayout:constraintlayout:2.0.0-beta2"
  const val androidxCoreCoreKtx = "androidx.core:core-ktx:1.2.0-alpha03"
  const val androidxFragmentFragmentTesting = "androidx.fragment:fragment-testing:1.2.0-alpha02"
  ...
  const val androidxRecyclerviewRecyclerview = "androidx.recyclerview:recyclerview:1.1.0-beta03"
  const val androidxRoomRoomCompiler = "androidx.room:room-compiler:2.2.0-alpha02"
  const val androidxRoomRoomRuntime = "androidx.room:room-runtime:2.2.0-alpha02"
  const val androidxRoomRoomKtx = "androidx.room:room-ktx:2.2.0-alpha02"
  const val androidxRoomRoomTesting = "androidx.room:room-testing:2.2.0-alpha02"
  ...
  const val androidxWorkWorkRuntimeKtx = "androidx.work:work-runtime-ktx:2.2.0"
  ...
  const val comGithubBenManesGradleVersionsPlugin = "com.github.ben-manes:gradle-versions-plugin:0.22.0"
  const val comGithubIhsanbalLoggingInterceptor = "com.github.ihsanbal:LoggingInterceptor:3.0.0"
  const val comGithubTripletGradlePlayPublisher = "com.github.triplet.gradle:play-publisher:2.3.0"
  const val comGoogleAndroidGmsPlayServicesVision = "com.google.android.gms:play-services-vision:18.0.0"
  const val comGoogleAndroidMaterialMaterial = "com.google.android.material:material:1.1.0-alpha09"
  const val comGoogleCodeGsonGson = "com.google.code.gson:gson:2.8.5"
  const val comGoogleFirebaseFirebaseConfig = "com.google.firebase:firebase-config:19.0.0"
  const val comGoogleFirebaseFirebaseCore = "com.google.firebase:firebase-core:17.1.0"
  ...
  const val comSquareupOkhttp3LoggingInterceptor = "com.squareup.okhttp3:logging-interceptor:4.1.0"
  const val comSquareupOkhttp3MockWebServer = "com.squareup.okhttp3:mockwebserver:4.1.0"
  const val comSquareupOkhttp3Okhttp = "com.squareup.okhttp3:okhttp:4.1.0"
  const val comSquareupRetrofit2ConverterGson = "com.squareup.retrofit2:converter-gson:2.6.1"
  const val comSquareupRetrofit2Retrofit = "com.squareup.retrofit2:retrofit:2.6.1"
  ...
  const val orgJetbrainsKotlinxKotlinxCoroutinesAndroid = "org.jetbrains.kotlinx:kotlinx-coroutines-android:1.3.0-RC2"
  const val orgJetbrainsKotlinxKotlinxCoroutinesCore = "org.jetbrains.kotlinx:kotlinx-coroutines-core:1.3.0-RC2"
