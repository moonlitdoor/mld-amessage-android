object D {
  ...
  const val androidxTestEspressoEspressoCore = "androidx.test.espresso:espresso-core:3.3.0-alpha01"
  const val androidxTestEspressoEspressoIdlingResource = "androidx.test.espresso:espresso-idling-resource:3.3.0-alpha01"
  const val androidxTestEspressoIdlingIdlingConcurrent = "androidx.test.espresso.idling:idling-concurrent:3.3.0-alpha01"
  ...
  const val androidxWorkWorkRuntimeKtx = "androidx.work:work-runtime-ktx:2.1.0-rc01"
  ...
  const val comGoogleTruthTruth = "com.google.truth:truth:1.0-rc1"
  ...
  const val comSquareupOkhttp3Okhttp = "com.squareup.okhttp3:okhttp:4.0.0"
  const val comSquareupOkhttp3LoggingInterceptor = "com.squareup.okhttp3:logging-interceptor:4.0.0"
  const val comSquareupOkhttp3MockWebServer = "com.squareup.okhttp3:mockwebserver:4.0.0"
